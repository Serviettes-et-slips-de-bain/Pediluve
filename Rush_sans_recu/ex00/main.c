...
/*   Updated: 2019/09/07 22:14:16 by yotillar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_put_tower2(int tab[5][5], int donnees[17])
{
...
void	ft_put_tower(int tab[5][5], int donnees[17], int x, int y)
{
	int i;
		...
		if (test_line(tab, x, y) == 1 && test_column(tab, x, y) == 1)
		{
			if (y == 4)
			{
				if ((ft_column_left(tab, donnees, x) == 1)
					...
					ft_put_tower(tab, donnees, x + 1, 1);
			}
			else
...
int		raccourci(int tab[5][5], int donnees[17], char **argv)
{
	int i;
	int j;
